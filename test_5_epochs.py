#!/usr/bin/env python3
"""
Quick test with 5 epochs to complete the 1-5 epoch range requested.
Using just 10 capitals for faster execution.
"""
...
def test_5_epochs():
    """Quick test with 5 epochs using 10 capitals."""

    # Test with 10 capitals for faster validation
    capitals_data = [
        ("France", "Paris"),
        ("Germany", "Berlin"),
        ("Italy", "Rome"),
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        print("🔍 Quick test with 10 capitals and 5 epochs...")
        ...
        # Test with 5 epochs (maximum requested range)
        workflow.config.optimization.epochs = 5
