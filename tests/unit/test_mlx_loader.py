...
class TestMLXModelLoader:
    ...
    def test_should_skip_weight(self, loader):
        ...
        assert not loader._should_skip_weight("lm_head.weight")
    ...
    def test_get_name_mapping_gpt(self, loader):
        ...
        assert "wte.weight" in mapping
        assert mapping["wte.weight"] == "wte.weight"
        assert mapping["wpe.weight"] == "wpe.weight"
        assert mapping["ln_f.weight"] == "ln_f.weight"
    ...
    def test_load_pytorch_weights_bin(self, loader, temp_dir):
        ...
        # Mock torch.load at import location
    ...
    @patch("finetune.models.mlx_loader.get_mlx_model")
    def test_load_from_huggingface(self, mock_get_model, mock_download, loader, temp_dir):
